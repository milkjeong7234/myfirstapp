...
st.write("당신의 성격 유형에 맞는 포켓몬 친구를 추천해드립니다!")
...
# MBTI별 포켓몬 추천 딕셔너리
pokemon_dict = {
    "INTJ": ("뮤츠", "지적인 전략가, 고독하지만 강한 힘을 지닌 전설의 포켓몬."),
    "INTP": ("프리져", "호기심 많은 탐구자, 논리적이고 차가운 매력을 가진 얼음 타입 포켓몬."),
    "ENTJ": ("리자몽", "강한 리더십과 추진력! 모두를 이끄는 카리스마의 화염 포켓몬."),
    ...
    "ENFJ": ("루카리오", "타인을 이끄는 따뜻한 카리스마, 강한 정의감을 지닌 전사."),
    "ENFP": ("고라파덕", "엉뚱하지만 창의력 넘치는 자유로운 영혼."),
    "ISTJ": ("거북왕", "신중하고 책임감 있는 타입, 철저한 방어력으로 팀을 지키는 포켓몬."),
    ...
    "ISTP": ("팬텀", "조용하고 분석적인 전사, 싸움에 능한 그림자 같은 존재."),
